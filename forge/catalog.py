...
CATALOG: Dict[str, dict] = {
    ...
    "gcf": {
        ...
        "directions": "Find the greatest common factor.",
        "workspace": "1.1cm",
        "progression": [
            _s("numerical", "easy", columns=2),
            _s("monomial", "medium", group="Greatest Common Factor of Monomials",
               directions="Find the greatest common factor of each pair of monomials.", columns=2),
        ],
    },
    "linear_equations": {
    ...
    "exponents": {
        ...
        "progression": [
            ...
            _s("multivariable_simplify", "hard",
               group="Multivariable Exponent Properties",
               directions="Simplify. Write your answers with positive exponents.",
               workspace="1.6cm", columns=2),
        ],
    },
    "inequalities": {
        ...
        "progression": [
            ...
            _s("fractional_both_sides", "hard", columns=2),
               ...
               workspace="2.0cm", columns=2),
            _s("compound_or", "hard",
               group="Compound Inequalities (Or)",
               directions="Solve each compound inequality for $x$.",
               workspace="2.0cm", columns=2),
],
    },
    ...
    "statistics": {
        ...
        "progression": [
            ...
            _s("five_number_summary", "hard",
               group="Five-Number Summary",
               directions=("Give the five-number summary: minimum, $Q_1$, "
                           "median, $Q_3$, maximum."),
    ...
    "probability": {
        ...
        "progression": [
            ...
            _s("permutations", "medium",
               group="Counting",
               directions="Find each count.",
               workspace="1.6cm", columns=1),
            _s("combinations", "medium",
               group="Counting",
               directions="Find each count.",
               workspace="1.6cm", columns=1),
    ...
    "functions": {
        ...
        "workspace": "1.8cm",
        "progression": [
            _s("evaluate_function", "easy",
               group="Evaluating Functions",
               directions="Evaluate each function at the given value.",
               workspace="1.5cm", columns=2),
            _s("substitution", "easy",
               group="Evaluating with Given Values",
               directions="Evaluate each expression using the values given.",
               workspace="1.5cm", columns=2),
            _s("inverse_linear", "easy", columns=2),
            _s("domain_range", "medium",
               group="Domain and Range",
               directions="State the domain and range of each relation.",
               workspace="1.6cm", columns=1),
            _s("literal_equation", "medium",
               group="Literal Equations",
               directions="Solve each equation for the indicated variable.",
               workspace="1.8cm", columns=2),
            _s("composition", "medium",
               group="Composition of Functions",
               directions="Find $f(g(x))$ and simplify.",
               workspace="1.8cm", columns=2),
            # A full sentence describing the transformation -- needs the width.
            _s("transformation_equation", "medium",
               group="Transformations",
               directions="Write the equation of each transformed function.",
               workspace="1.6cm", columns=1),
        ],
    },
    "oblique_trig": {
        ...
        "directions": (
            "Find the missing side. Leave answers in exact form."
        ),
        "workspace": "2.0cm",
        "progression": [
            _s("law_of_cosines", "medium", columns=1),
            _s("law_of_sines", "medium",
               group="Law of Sines",
               directions="Find the missing side. Leave answers in exact form.",
               workspace="2.0cm", columns=1),
        ],
    },
    "trig_graphs": {
        "name": "Graphing Trigonometric Functions",
        "directions": "Find the amplitude of each function.",
        "workspace": "1.3cm",
        "progression": [
            _s("amplitude", "easy", columns=2),
            _s("period", "medium",
               group="Period",
               directions="Find the period of each function.",
               workspace="1.3cm", columns=2),
            _s("phase_shift", "medium",
               group="Phase Shift",
               directions=("Find the phase shift of each function. A shift to "
    ...
    "decimals": {
        "name": "Decimals",
        "directions": "Evaluate. Write each answer as a decimal.",
        "workspace": "1.3cm",
        "progression": [
            _s("add_sub_decimals", "easy", columns=2),
            _s("multiply_decimals", "easy", columns=2),
            _s("divide_decimals", "medium", columns=2),
            _s("decimal_to_fraction", "easy",
               group="Decimals to Fractions",
               directions="Write each decimal as a fraction in lowest terms.",
               workspace="1.2cm", columns=2),
            _s("fraction_to_decimal", "easy",
               group="Fractions to Decimals",
               directions="Write each fraction as a decimal.",
               workspace="1.2cm", columns=2),
            _s("decimal_to_percent", "easy",
               group="Decimals to Percents",
               directions="Write each decimal as a percent.",
               workspace="1.1cm", columns=2),
            _s("percent_to_decimal", "easy",
               group="Percents to Decimals",
    ...
    "lcm": {
        ...
        "directions": "Find the least common multiple.",
        "workspace": "1.3cm",
        "progression": [
            _s("numerical", "easy", columns=2),
            _s("monomial", "medium", columns=2),
            _s("prime_factorization", "easy",
               group="Prime Factorization",
               directions="Write each number as a product of primes.",
               workspace="1.6cm", columns=2),
        ],
    },
    "angles": {
        "name": "Angle Relationships",
        "directions": "Find each missing angle.",
        "workspace": "1.5cm",
        "progression": [
            # Every item is a full sentence -- single column.
            _s("complementary", "easy", columns=1),
            _s("supplementary", "easy", columns=1),
            _s("triangle_missing_angle", "medium", columns=1),
            _s("polygon_interior_sum", "medium",
               group="Polygon Interior Angles",
               directions="Find the sum of the interior angles.",
               workspace="1.5cm", columns=1),
            _s("vertical_and_transversal", "hard",
               group="Parallel Lines and Transversals",
               directions="Find each missing angle.",
               workspace="1.5cm", columns=1),
        ],
    },
    "coordinate": {
        ...
        "workspace": "1.8cm",
        "progression": [
            _s("distance", "easy", columns=2),
            _s("midpoint", "easy",
               group="Midpoint",
               directions="Find the midpoint of each pair of points.",
               workspace="1.6cm", columns=2),
            _s("translate_point", "easy",
               group="Translations",
               directions="Find the coordinates of each image.",
               workspace="1.3cm", columns=1),
            _s("reflect_point", "medium",
               group="Reflections",
               directions="Find the coordinates of each image.",
               workspace="1.3cm", columns=1),
        ],
    ...
    "roots": {
        ...
        "progression": [
            ...
            _s("simplify_cube_radical", "medium",
               ...
               directions="Simplify each radical completely.",
               workspace="1.3cm", columns=2),
            _s("simplify_radical_variables", "hard",
               group="Simplifying Radicals With Variables",
               directions=(
                   "Simplify the following using radical properties. "
    ...
    "geometry": {
        ...
        "progression": [
            ...
            _s("volume_tri_prism", "medium",
               ...
               directions="Find the volume of each prism.",
               workspace="1.8cm", columns=1),
            _s("volume_cylinder", "medium",
               group="Cylinders, Cones and Spheres",
               directions=("Find the volume. Leave answers in terms of "
                           "$\\pi$."),
               workspace="1.8cm", columns=1),
            _s("volume_cone", "medium",
               group="Cylinders, Cones and Spheres",
               directions=("Find the volume. Leave answers in terms of "
                           "$\\pi$."),
               workspace="1.8cm", columns=1),
            _s("volume_sphere", "hard",
               group="Cylinders, Cones and Spheres",
               directions=("Find the volume. Leave answers in terms of "
                           "$\\pi$."),
               workspace="1.8cm", columns=1),
            _s("surface_area_cylinder", "hard",
               group="Surface Area of a Cylinder",
               directions=("Find the surface area. Leave answers in terms of "
                           "$\\pi$."),
               workspace="1.8cm", columns=1),
    ...
    "quadratics": {
        ...
        "progression": [
            ...
            _s("find_vertex", "medium",
               ...
               workspace="1.8cm", columns=2),
            _s("vertex_and_direction", "medium",
               group="Vertex and Direction of a Parabola",
               directions=(
                   "State the vertex of each parabola, then state whether it "
                   "has a maximum or a minimum."
               ),
               workspace="1.8cm", columns=2),
            _s("complete_the_square_blank", "hard",
               group="Completing the Square",
               directions="State the values that belong in the blanks to complete the square.",
               workspace="2.2cm", columns=1),
            _s("vertex_form_complete_square", "hard",
               group="Vertex Form by Completing the Square",
               directions="Change the standard form to vertex form by completing the square.",
               workspace="2.4cm", columns=1),
        ],
    },
    "rational_expressions": {
        ...
        "progression": [
            ...
            _s("multiply", "medium",
               ...
               workspace="1.8cm", columns=2),
                    _s("solve_rational_equation", "medium",
               group="Solving Rational Equations",
               directions="Solve each equation for $x$.",
               workspace="2.0cm", columns=2),
],
    },
    "polynomials": {
        ...
        "workspace": "1.6cm",
        "progression": [
            _s("classify_polynomial", "easy",
               group="Classifying Polynomials",
               directions=(
                   "Classify each as monomial, binomial, trinomial, "
                   "polynomial, or constant."
               ),
               workspace="0.4cm", columns=2),
            _s("standard_form", "easy",
               group="Standard Form",
               directions="Rewrite each polynomial in standard form.",
               workspace="1.3cm", columns=2),
            _s("add_polynomials", "medium",
               group="Adding Polynomials",
               directions="Add the following polynomials by combining like terms.",
               workspace="1.6cm", columns=2),
            _s("subtract_polynomials", "medium",
               group="Subtracting Polynomials",
               directions="Subtract the following polynomials by combining like terms.",
               workspace="1.6cm", columns=2),
            _s("multiply_monomial", "easy",
               group="Multiplying Monomials by Polynomials",
               directions="Find the following products. Write your answers in standard form.",
               workspace="1.4cm", columns=2),
            _s("multiply_binomials", "easy",
               group="Multiplying Monomials by Polynomials",
               directions="Find the following products. Write your answers in standard form.",
               workspace="1.4cm", columns=2),
            _s("multiply_poly", "medium",
               group="Multiplying Monomials by Polynomials",
               directions="Find the following products. Write your answers in standard form.",
               workspace="1.8cm", columns=2),
            _s("divide_by_monomial", "medium",
               group="Dividing by a Monomial",
               directions="Divide. Remember to divide every term of the polynomial.",
               workspace="1.6cm", columns=2),
            _s("factor_trinomial", "medium",
               group="Factoring Trinomials",
               directions="Factor each trinomial completely.",
               workspace="1.6cm", columns=2),
            _s("factor_trinomial_lead", "hard",
               group="Factoring Trinomials",
               directions="Factor each trinomial completely.",
               workspace="1.8cm", columns=2),
            _s("synthetic_division", "medium",
               group="Dividing Polynomials",
               directions="Divide. Write the quotient.",
               workspace="2.0cm", columns=2),
            _s("factor_by_grouping", "hard",
               group="Factoring by Grouping",
            ...
            _s("difference_of_squares", "medium",
               ...
               workspace="1.6cm", columns=2),
            _s("factor_difference_of_squares_lead", "hard",
               group="Factoring a Difference of Squares",
               directions="Factor each expression completely.",
               workspace="1.6cm", columns=2),
        ],
    ...
    "exponential_logarithms": {
        ...
        "progression": [
            ...
            _s("condense_log", "hard",
               ...
               workspace="1.4cm", columns=2),
                    _s("growth_decay", "medium",
               group="Growth and Decay",
